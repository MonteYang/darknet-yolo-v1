...
char *voc_names[] = {"Truck", "Van", "Tram", "Car"};

void train_yolo(char *cfgfile, char *weightfile)
{
    char *train_images = "/home/yang/yolo_tensorflow/data/KITTI/ImageSets/Layout/train.txt";
    char *backup_directory = "/home/yang/darknet/backup/";
    srand(time(0));
...
void validate_yolo(char *cfg, char *weights)
{
    ...
    list *plist = get_paths("/home/yang/yolo_tensorflow/data/KITTI/ImageSets/Layout/val.txt");
...
void test_yolo(char *cfgfile, char *weightfile, char *filename, float thresh)
{
    ...
    while(1){
        ...
        draw_detections(im, dets, l.side*l.side*l.n, thresh, voc_names, alphabet, 4);
